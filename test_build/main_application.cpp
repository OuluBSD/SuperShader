...
int main()
{
    ...
    lightingShader.setVec3("lightPositions[0]", 0, 0, 5);
    lightingShader.setVec3("lightColors[0]", 1, 1, 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::translate(model, glm::vec3(0, 0, 0)); // translate it down so it's at the center of the scene
